...
def create(
    ...
    return create_message(db, payload, user)
...
def get_item(
    ...
    return get_message(message_id, db, user)
...
def delete_item(
    ...
    remove_message(message_id, db, user)
...
def update_item(
    ...
    return update_message_item(message_id, payload, db, user)
